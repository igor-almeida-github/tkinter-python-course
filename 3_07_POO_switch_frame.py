...
class DistanceConverterRoot(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frame_mf = MetersToFeetFrame(self, container, padding=(30, 15))
        self.frame_mf.grid(row=0, column=0)
        self.frame_fm = FeetToMetersFrame(self, container, padding=(30, 15))
        self.frame_fm.grid(row=0, column=0)
...
class MetersToFeetFrame(ttk.Frame):
    def __init__(self, controller, *args, **kwargs):
        ...
        switch_page_button = ttk.Button(self, text='Switch', command=lambda: controller.frame_fm.tkraise())
...
class FeetToMetersFrame(ttk.Frame):
    def __init__(self, controller, *args, **kwargs):
        ...
        switch_page_button = ttk.Button(self, text='Switch', command=lambda: controller.frame_mf.tkraise())
        switch_page_button.grid(column=0, row=3, columnspan=2, sticky='ew')
